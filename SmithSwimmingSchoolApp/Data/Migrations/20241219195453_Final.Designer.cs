...
namespace SmithSwimmingSchoolApp.Data.Migrations
{
    ...
    [Migration("20241219195453_Final")]
    partial class Final
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmithSwimmingSchoolApp.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GroupId = 1,
                            End_Date = new DateTime(2025, 1, 8, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8693),
                            Level = 1,
                            Name = "Braza Mañana",
                            Start_Date = new DateTime(2024, 12, 9, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8647)
                        },
                        new
                        {
                            GroupId = 2,
                            End_Date = new DateTime(2025, 1, 13, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8698),
                            Level = 2,
                            Name = "Braza Tarde",
                            Start_Date = new DateTime(2024, 12, 14, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8697)
                        },
                        new
                        {
                            GroupId = 3,
                            End_Date = new DateTime(2025, 1, 10, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8702),
                            Level = 1,
                            Name = "Flotación y Propulsión Mañana",
                            Start_Date = new DateTime(2024, 12, 11, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8700)
                        },
                        new
                        {
                            GroupId = 4,
                            End_Date = new DateTime(2025, 1, 16, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8705),
                            Level = 3,
                            Name = "Flotación y Propulsión Tarde",
                            Start_Date = new DateTime(2024, 12, 17, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8704)
                        },
                        new
                        {
                            GroupId = 5,
                            End_Date = new DateTime(2025, 1, 18, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8709),
                            Level = 1,
                            Name = "Mariposa Mañana",
                            Start_Date = new DateTime(2024, 12, 19, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8707)
                        },
                        new
                        {
                            GroupId = 6,
                            End_Date = new DateTime(2025, 1, 21, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8712),
                            Level = 2,
                            Name = "Mariposa Tarde",
                            Start_Date = new DateTime(2024, 12, 22, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8711)
                        },
                        new
                        {
                            GroupId = 7,
                            End_Date = new DateTime(2025, 1, 19, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8715),
                            Level = 2,
                            Name = "Crol Mañana",
                            Start_Date = new DateTime(2024, 12, 20, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8714)
                        },
                        new
                        {
                            GroupId = 8,
                            End_Date = new DateTime(2025, 1, 25, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8719),
                            Level = 3,
                            Name = "Crol Tarde",
                            Start_Date = new DateTime(2024, 12, 26, 20, 54, 53, 195, DateTimeKind.Local).AddTicks(8717)
                        });
                });
